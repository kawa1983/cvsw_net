/*
 * vxlan_sclp_tx1.c : CVSW vxlan_sclp test entries (sender)
 * 
...
extern bool cvsw_test_add_entry3(struct net_device *dev)
{
    ...
    struct ofp_ext_action_vxlan_sclp vxlan_sclp;

    init_cvsw_hdr(&hdr, sizeof(flow) + sizeof(vxlan_sclp));
    ...
    memset(&vxlan_sclp, 0, sizeof(vxlan_sclp));
    vxlan_sclp.type = htons(OFPAT_EXT_SET_VXLAN_SCLP);
    vxlan_sclp.len  = htons(sizeof(vxlan_sclp));
    vxlan_sclp.dl_dest[0]     = 0x22;
    vxlan_sclp.dl_dest[1]     = 0x22;
    vxlan_sclp.dl_dest[2]     = 0x22;
    vxlan_sclp.dl_dest[3]     = 0x22;
    vxlan_sclp.dl_dest[4]     = 0x22;
    vxlan_sclp.dl_dest[5]     = 0x22;
    vxlan_sclp.dl_src[0]      = 0x11;
    vxlan_sclp.dl_src[1]      = 0x11;
    vxlan_sclp.dl_src[2]      = 0x11;
    vxlan_sclp.dl_src[3]      = 0x11;
    vxlan_sclp.dl_src[4]      = 0x11;
    vxlan_sclp.dl_src[5]      = 0x11;
    vxlan_sclp.nw_dest[0]     = 172;
    vxlan_sclp.nw_dest[1]     = 16;
    vxlan_sclp.nw_dest[2]     = 0;
    vxlan_sclp.nw_dest[3]     = 2;
    vxlan_sclp.nw_src[0]      = 172;
    vxlan_sclp.nw_src[1]      = 16;
    vxlan_sclp.nw_src[2]      = 0;
    vxlan_sclp.nw_src[3]      = 1;
    vxlan_sclp.vxlan_sclp_vni = htonl(10);

    skb = cvsw_alloc_skb(sizeof(hdr) + sizeof(flow) + sizeof(vxlan_sclp), dev);
    if (! skb) {
	return false;
    }
    ...
    memcpy(skb_put(skb, sizeof(vxlan_sclp)), &vxlan_sclp, sizeof(vxlan_sclp));
