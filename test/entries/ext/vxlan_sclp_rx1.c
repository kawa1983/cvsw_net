/*
 * vxlan_sclp_rx1.c : CVSW vxlan_sclp test entries (receiver)
 * 
...
extern bool cvsw_test_add_entry3(struct net_device *dev)
{
    ...
    struct ofp_action_header vxlan_sclp;
    ...
    vxlan_sclp.type = htons(OFPAT_EXT_STRIP_VXLAN_SCLP);
